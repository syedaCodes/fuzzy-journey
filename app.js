...
const handleSubmit = (e) => {
    ...
    if(userData.firstname === ""){
        ...
        e.preventDefault();
        let billingEmail = (userData.email).toString();
        const domain = 'https://enrol.albalaghacademy.org/';
        location.href= `${domain}${courseCode}?billing_first_name=${userData.firstname}&billing_email=${billingEmail}`;
    }
...
const defaultForm = () => {
    ...
    <div class="radioButtons">
        ...
        <label for="eur"><input type="radio" name="currency" value="eur" id="eur">Euro (&euro;)</label>
    </div>
